...
CREATE TABLE IF NOT EXISTS weather (
  ...
  stadium VARCHAR(100) COMMENT 'Stadium name',
  team VARCHAR(100) COMMENT 'Team name',
  PRIMARY KEY (weather_id),
  UNIQUE INDEX idx_station_valid (station, valid)
) COMMENT 'Weather data from closest weather stations to MLB stadiums';
"""
...
schemas = [_pitch, _person, _event, _game, _sub, _weather]
